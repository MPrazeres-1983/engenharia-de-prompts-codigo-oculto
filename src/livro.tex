...
\newgeometry{margin=0pt} % sem margens nesta página

\begin{titlepage}
  \thispagestyle{empty}
  \centering
  \includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio]{capa_livro}%
\end{titlepage}

\restoregeometry      % volta às margens normais para o resto do livro
\clearpage

% --------- FRONTMATTER E ÍNDICE ---------
\frontmatter

% Se quiseres manter a página de título em texto, deixa esta linha.
% Se não quiseres, comenta-a com % no início.
\maketitle

\tableofcontents


% (Opcional) Espaço para dedicat'oria ou agradecimentos futuros
% \chapter*{Dedicat'oria}
% Texto a adicionar mais tarde.
